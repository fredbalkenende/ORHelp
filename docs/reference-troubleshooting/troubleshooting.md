...
When OfficeReports is missing in Excel or PowerPoint, please do the following 2 steps to get the menu back.

#### First: Check if OfficeReports is disabled

If you have run into an error on your computer while working on OfficeReports, you might see this message, when restarting Excel or PowerPoint:! \[addin problems message](/Resources/Images/OfficeReportsAnalytics/First Check if OfficeReports\_654x266.png)
...
* In the bottom of this window select 'Manage Disabled' items:! \[Select ' Disabled Items'](/Resources/Images/OfficeReportsAnalytics/First Check if OfficeReports\_1.png)
...
If this is not solving the issue, please contact OfficeReports Support at \[helpdesk@officereports.com](mailto:helpdesk@officereports.com)



!\[OfficeReports Setup Form](/Resources/Images/OfficeReportsAnalytics/Second Reregister OfficeReports.png)



[Video: Reactivate OfficeReports](http://youtu.be/dEPa72VJLSI?hd=1)
